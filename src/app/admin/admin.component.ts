...
export class AdminComponent implements OnInit, AfterViewInit {
  ...
  JqueryMethod = () => {
    (function($) {
      ...
      var closeNav = function() {
        $(".ttr-overlay, .ttr-sidebar-toggle-button,.a").on(
          "click",
          function() {
            $("body").removeClass("ttr-opened-sidebar"),
              $("body").removeClass("ttr-body-fixed");
          }
        );
      };
  ...
  /**  Implmt Jquery Method */

  /** Implement Jquery Method Close */
}
